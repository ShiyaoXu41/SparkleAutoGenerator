...
'''
############################
# generate nums for tb_add.sv
############################

print(signed_dec2hex(-10, 4))
print(signed_dec2hex(-8, 4))
print(signed_dec2hex(-5, 4))
print(signed_dec2hex(-2, 4))

print(signed_dec2hex(-3, 4))
print(signed_dec2hex(-12, 4))
'''
...
def unsigned_dec2bin(data, width):
    data_bin = bin(data).replace("0b", "")
    while(len(data_bin) < width):
        data_bin = "0" + data_bin
    return data_bin



def unsigned_bin2hex(data, width):
    data_hex = hex(int(data,2)).replace("0x","")
    while(len(data_hex) < width):
        data_hex = "0" + data_hex
    return data_hex



def unsigned_hex2bin(data, width):
    data_bin = bin(int(data,16)).replace("0b","")
    while(len(data_bin) < width):
        data_bin = "0" + data_bin
    return data_bin
...
def unsigned_dec2hex(data, width):
    data_hex = hex(data).replace("0x","")
    while(len(data_hex) < width):
        data_hex = "0" + data_hex
    return data_hex
